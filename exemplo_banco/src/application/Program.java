...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Este valor de depósito inicial, entretanto, é opcional, ou seja: se o titular
		 * não tiver dinheiro a depositar no momento de abrir sua conta, o depósito
		 ...
		 * para proteger isso. O saldo só aumenta por meio de depósitos, e só diminui
		 * por meio de saques. Para cada saque realizado, o banco cobra uma taxa de $
		 * 5.00. Nota: a conta pode ficar com saldo negativo se o saldo não for
		...
		System.out.printf("Account: %d %n", account.getNumber());
		System.out.printf("Holder: %s %n", account.getName());
